...
class _ProviderChatMessageScreenState extends State<ProviderChatMessageScreen> {
  ...
  Future<void> _fetchMessages() async {
    try {
      final response = await http.get(
        Uri.parse("https://nonregimented-ably-amare.ngrok-free.dev/nearfix/chat_handler.php?action=fetch&user1=${widget.currentUserId}&user2=${widget.peerId}"),
  ...
  Future<void> _sendMessage() async {
    ...
    await http.post(
      Uri.parse("https://nonregimented-ably-amare.ngrok-free.dev/nearfix/chat_handler.php?action=send"),
      body: {
